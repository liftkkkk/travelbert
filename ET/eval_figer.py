...
from run_typing import BertForEntityTyping
...
def main():
    ...
    for x, mark in file_mark:
        ...
        model = BertForEntityTyping.from_pretrained(args.bert_model, state_dict=model_state_dict, num_labels=len(label_list))
        model.to(device)
